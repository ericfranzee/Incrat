...
import 'package:it_academy/components/busy_loader.dart';
...
import 'package:it_academy/controllers/certificate.dart';
...
import 'package:it_academy/view/certificate/component/certificate_card.dart';
...
class _CertificateScreenState extends ConsumerState<CertificateScreen> {
  ...
  Future<bool?> downloadFile(String id, String name) async {
    ...
    try {
      ...
      print(' data download ${response.data} ${response.data} ');

      File file = File(filePath);
      print('This is fucking file ${file.path}');
