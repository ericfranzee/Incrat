...
import 'package:it_academy/view/courses/new_course/widget/video.dart';
...
class CourseDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('Total course duration ${model.course.totalDuration}');
    return Container(
              ...
              children: [
                ...
                CourseShortsInfo(
                    totalTime: ApGlobalFunctions.convertMinutesToHours(
                        model.course.totalDuration, context),
